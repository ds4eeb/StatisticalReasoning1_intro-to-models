...
## 2.1 Pika stress ~ elevation

### Q2.1 Make a question

Clearly articulate the question that you want to ask

-------

### Q2.2 Make a hypothesis

*Before* you look at the data, what direction of an effect do you expect? Do you think higher elevation would be associated with more or less stressed pikas? Why? Please write 1-2 sentences.
...
Assess whether the model ran correctly by looking at R hat, the chains, and the posterior distributions. Describe your thought process
